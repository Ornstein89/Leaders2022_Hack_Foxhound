<template>
  ...
  <v-row style="height: 100%" no-gutters fill-height>
    <v-col cols="12" sm="1">
      <v-card
        class="fill-height d-flex flex-column  ma-1">
            ...
            <template v-slot:activator="{ on, attrs }">
              <v-btn class="ma-1"
                ...
                <!-- <v-avatar color="primary"> -->
                  ...
                  <img width="50" src="https://uploads-ssl.webflow.com/62bebfb83044de7f13ae257e/62bec02423796903b293473e_Logo.svg">
                <!-- </v-avatar> -->
                </v-btn>
            </template>
...
export default {
  ...
  mounted() {
      ...
      this.dwvApp.loadURLs(["1-01.dcm"]) // для отладки загрузка из URL
